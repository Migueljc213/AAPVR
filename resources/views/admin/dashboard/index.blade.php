                        ...
                        {{-- <div class="row row-deck row-cards">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-10">
                                                ...
                                                <div class="markdown text-secondary">
                                                    ...
                                                    download any of the 4637 icons in SVG, PNG or&nbsp;React and use
                                                    them in
                                    ...
                                    <table class="table card-table table-vcenter">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="w-50">
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar bg-primary" style="width: 71.0%">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w-50">
                                                    <div class="progress progress-xs">
                                                        <div class="progress-bar bg-primary" style="width: 13.0%">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table card-table table-vcenter">
                                            ...
                                            <tr>
                                                ...
                                                <td class="w-100">
                                                    <a href="#" class="text-reset">Define users and
                                                        workflow</a>
                                                </td>
                                                <td class="text-nowrap text-secondary">
                                                    <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                          ...
                          <div class="col-12">
                            <div class="card">
                              ...
                              <div class="card-body">
                                <h3 class="card-title text-center">Bem-vindo(a) ao Painel Admin da AAPVR</h3>
                                <p class="text-secondary">
                                    O Painel Admin oferece uma interface amigável e intuitiva, voltada para a administração e gestão eficiente da plataforma. Ele é dividido em várias seções-chave que fornecem um panorama claro das operações e permitem fácil acesso a funcionalidades essenciais.</p>
                              </div>
                            </div>
                          </div>
                    </div>
