        ...
        <div class="page">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card-header d-flex align-item-center justify-content-between">
                                            <h5 class="mb-0">Listagem de Passeios</h5>
                                            <input type="text" class="form-control mb-3 rounded w-50"
                                                wire:model.live='search' placeholder="Pesquise passeios...">
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-striped"
                                                ...
                                                <tbody>
                                                    @if ($passeios)
                                                        @foreach ($passeios as $index => $passeio)
                                                            <tr class="text-center">
                                                                <td>
                                                                    {{ $passeio->titulo }}
                                                                </td>
                                                                ...
                                                                <td class="d-flex aling-items-center justify-content-center" style="gap: 10px">
                                                                    <img src="{{ asset($passeio->imagem1) }}" alt="" onclick="abrirGaleria('{{ asset($passeio->imagem1) }}')"
                                                                         class="rounded hover" height="50"
                                                                        style="object-fit: cover; max-width: 60px; max-height: 60px">
                                                                    <img src="{{ asset($passeio->imagem2) }}" alt="" onclick="abrirGaleria('{{ asset($passeio->imagem2) }}')"
                                                                         class="rounded hover" height="50"
                                                                        style="object-fit: cover; max-width: 60px; max-height: 60px">
                                                                    <img src="{{ asset($passeio->imagem3) }}" alt="" onclick="abrirGaleria('{{ asset($passeio->imagem3) }}')"
                                                                         class="rounded hover" height="50"
                                                                        style="object-fit: cover; max-width: 60px; max-height: 60px">
                                                                    <img src="{{ asset($passeio->imagem4) }}" alt="" onclick="abrirGaleria('{{ asset($passeio->imagem4) }}')"
                                                                         class="rounded hover" height="50"
                                                                        style="object-fit: cover; max-width: 60px; max-height: 60px">
                                                                </td>
                                                            
                                                                <td class="table-action">
                                                                    <a href="{{ route('passeios.edit', ['id' => $passeio['id']]) }}"
                                                                        class="btn btn-info btn-sm rounded-2">
                                                                        <i class="fa-solid fa-gear fa-1x"
                                                                            style="color: #fff"></i>
                                                                    </a>
                                                                    <a href="{{ route('passeios.destroy', ['id' => $passeio['id']]) }}"
                                                            ...
                                                            <div class="modal fade"
                                                                id="viewDetailsModal_{{ $passeio->id }}" tabindex="-1"
                                                                role="dialog"
                                                                aria-labelledby="viewDetailsModalLabel_{{ $passeio->id }}"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog modal-lg modal-dialog-scrollable"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <!-- Os detalhes do passeio serão preenchidos aqui pelo JavaScript -->
                                                                        </div>
                                                    ...
                                                    @else
                                                        <div class="card">
                                                            <p class="text-alert">Nenhum passeio cadastrado</p>
                                                        </div>
                                                    @endif
                                        ...
                                        {{ $passeios->links('vendor.pagination.bootstrap-5') }}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="modalNew" class="justify-content-center align-items-center">
                <div>
                    ...
                    <form action="{{ route('passeios.create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
